...
t3.end_use_desc,t3.price_cd,t3.pay_type_cd,t3.master_channel,t3.fabric_category_desc,t3.color_family_desc
from (
  select
...
group by t3.ilink,ref_date_month,ref_date_day,ref_date_year,t3.end_use_desc,t3.price_cd,t3.pay_type_cd,t3.master_channel,t3.fabric_category_desc,t3.color_family_desc
...
fts = ['end_use_desc','price_cd','pay_type_cd','master_channel','fabric_category_desc','color_family_desc']
...
df.to_pickle('../../data/Baseline/categoricalFts_3kUsers_Baseline.pkl')
